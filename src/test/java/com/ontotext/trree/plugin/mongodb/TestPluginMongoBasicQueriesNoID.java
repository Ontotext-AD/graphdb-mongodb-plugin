...
/**
 * The same as TestPluginMongoBasicQueries but using 'id' field instead of '@id' in source documents.
 * The conversion id -> @id is resolved by JSON-LD context ("id" : "@id").
 */
public class TestPluginMongoBasicQueriesNoID extends AbstractMongoBasicTest {
