...
/**
 * The whole idea behind this class is to decode encoded "." and "$" symbols in the JSON-LD keys in the mongo documents.
 */
public class EncoderWrapper implements Encoder<Document> {
  ...
  private class BsonWriterWrapper implements BsonWriter {
    ...
    public void writeName(String name) {
      writer.writeName(URLDecoder.decode(name, UTF_8));
    }
